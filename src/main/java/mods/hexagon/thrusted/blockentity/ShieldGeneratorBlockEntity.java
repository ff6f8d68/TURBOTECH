...
import mods.hexagon.thrusted.client.render.ThrustedIcosphere;
...
public class ShieldGeneratorBlockEntity extends BlockEntity implements BlockEntitySubLevelActor, MenuProvider {
    ...
    public static final int PROTECT_EXPLOSIONS = 1;
    public static final int PROTECT_BLOCK_BREAK = 2;
    public static final int PROTECT_DAMAGE = 4;
